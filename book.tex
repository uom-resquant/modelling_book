...
\hypersetup{
  ...
  pdfauthor={Reka Solymosi and Eon Kim (based on material developed with Juanjo Medina},
  hidelinks,
...
\includegraphics{imgs/consoleresults.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{num\_stores)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#that is going to be called crime\_f. Typically, when you alter}
...
\CommentTok{\#as\_factor() function to explain to R that what we want to do}
...
\NormalTok{banbox}\SpecialCharTok{$}\NormalTok{crime\_f }\OtherTok{\textless{}{-}} \FunctionTok{as\_factor}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{crime\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{banbox}\SpecialCharTok{$}\NormalTok{black\_f }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black)}
\CommentTok{\#You can check that the resulting column is a factor}
\FunctionTok{class}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{levels}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{levels}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"White"}\NormalTok{, }\StringTok{"Black"}\NormalTok{)}
\FunctionTok{table}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{black\_f)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{is.na}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{response\_black[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{response\_black)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{response\_black))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(banbox}\SpecialCharTok{$}\NormalTok{daystoresponse)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{02-causality_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ fbo, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ club\_supported, }\AttributeTok{y=}\NormalTok{banning\_orders)) }\SpecialCharTok{+}  \CommentTok{\#data}
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat =} \StringTok{"identity"}\NormalTok{) }\SpecialCharTok{+}                                  \CommentTok{\#geometry 1 }
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}                                                 \CommentTok{\#geometry 2}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(fbo}\SpecialCharTok{$}\NormalTok{banning\_orders)) }\SpecialCharTok{+}            \CommentTok{\#mean line}
\FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{angle =} \DecValTok{90}\NormalTok{, }\AttributeTok{hjust =} \DecValTok{1}\NormalTok{))                                                      }\CommentTok{\#backgroud coordinate system}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fbo}\SpecialCharTok{$}\NormalTok{league\_of\_the\_club\_supported }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(fbo}\SpecialCharTok{$}\NormalTok{league\_of\_the\_club\_supported, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Premier League"}\NormalTok{, }\StringTok{"Championship"}\NormalTok{, }\StringTok{"League One"}\NormalTok{, }\StringTok{"League Two"}\NormalTok{, }\StringTok{"Other clubs"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(Boston}\SpecialCharTok{$}\NormalTok{crim }\SpecialCharTok{\textless{}} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Boston}\SpecialCharTok{$}\NormalTok{lowval[Boston}\SpecialCharTok{$}\NormalTok{medv }\SpecialCharTok{\textless{}=} \FloatTok{17.02}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"Low value"} 
\NormalTok{Boston}\SpecialCharTok{$}\NormalTok{lowval[Boston}\SpecialCharTok{$}\NormalTok{medv }\SpecialCharTok{\textgreater{}} \FloatTok{17.02}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"Higher value"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(Boston}\SpecialCharTok{$}\NormalTok{lowval)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Boston}\SpecialCharTok{$}\NormalTok{lowval }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(Boston}\SpecialCharTok{$}\NormalTok{lowval)}
\FunctionTok{class}\NormalTok{(Boston}\SpecialCharTok{$}\NormalTok{lowval)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(Boston}\SpecialCharTok{$}\NormalTok{dec\_medv)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Boston\_spm }\OtherTok{\textless{}{-}}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(Boston, crim, medv, lstat, chas)}
\FunctionTok{spm}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{crim}\SpecialCharTok{+}\NormalTok{medv}\SpecialCharTok{+}\NormalTok{lstat, }\AttributeTok{data=}\NormalTok{Boston\_spm, }\AttributeTok{groups=}\NormalTok{Boston\_spm}\SpecialCharTok{$}\NormalTok{chas, }\AttributeTok{by.groups=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{smooth=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{regLine=}\ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-60-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-64-1.pdf}
...
\FunctionTok{print}\NormalTok{(}\FunctionTok{levels}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{walkday))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{BCS0708}\SpecialCharTok{$}\NormalTok{walkdayR }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{walkday, }\AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}very safe\textquotesingle{}}\NormalTok{,}
  \StringTok{\textquotesingle{}fairly safe\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}a bit unsafe\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}or very unsafe\textquotesingle{}}\NormalTok{))}
\CommentTok{\#Plotting the variable again (and subsetting out the NA data)}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{subset}\NormalTok{(BCS0708, }\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(walkdayR)), }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{walkdayR)) }\SpecialCharTok{+}
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..prop.., }\AttributeTok{group =} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-67-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-69-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\includegraphics{03-visualisation_files/figure-latex/unnamed-chunk-71-1.pdf}
...
\begin{figure}
\centering
\includegraphics{imgs/piechart.jpg}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(dplyr)}
\CommentTok{\#First, let\textquotesingle{}s see what type of vector isocntry is}
\FunctionTok{class}\NormalTok{(eb85\_3}\SpecialCharTok{$}\NormalTok{isocntry)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(eb85\_3}\SpecialCharTok{$}\NormalTok{qb10\_1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(eb85\_3}\SpecialCharTok{$}\NormalTok{qb10\_1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(eb85\_3}\SpecialCharTok{$}\NormalTok{qb10\_1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{mutate}\NormalTok{(df, }
       \AttributeTok{at\_sexviol =}\NormalTok{ qb10\_1 }\SpecialCharTok{+}\NormalTok{ qb10\_2 }\SpecialCharTok{+}\NormalTok{ qb10\_3 }\SpecialCharTok{+}\NormalTok{ qb10\_4 }\SpecialCharTok{+}
\NormalTok{         qb10\_5 }\SpecialCharTok{+}\NormalTok{ qb10\_6 }\SpecialCharTok{+}\NormalTok{ qb10\_7 }\SpecialCharTok{+}\NormalTok{ qb10\_8 }\SpecialCharTok{+}\NormalTok{ qb10\_9)}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{at\_sexviol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{qb10\_10)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{qb10\_11)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{qb10\_12)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{at\_sexviol[df}\SpecialCharTok{$}\NormalTok{qb10\_11 }\SpecialCharTok{==} \DecValTok{1} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{qb10\_12 }\SpecialCharTok{==} \DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{at\_sexviol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{isocntry)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{isocntry)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{region[df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"AT"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"BE"} \SpecialCharTok{|} 
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"CZ"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"DE{-}E"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"DE{-}W"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"FR"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"GB{-}GBN"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"GB{-}NIR"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"IE"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"LU"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"NL"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"Western"}
\NormalTok{df}\SpecialCharTok{$}\NormalTok{region[df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"BG"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"EE"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"HU"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"LT"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"LV"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"PL"} \SpecialCharTok{|}
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"RO"} \SpecialCharTok{|} 
\NormalTok{            df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"SK"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"Eastern"}
\NormalTok{df}\SpecialCharTok{$}\NormalTok{region[df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==} \StringTok{"DK"} \SpecialCharTok{|}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{isocntry }\SpecialCharTok{==}\StringTok{"FI"} \SpecialCharTok{|}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{d10)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occupation)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occupation)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occupation)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df}\SpecialCharTok{$}\NormalTok{f\_occup }\OtherTok{\textless{}{-}} \FunctionTok{to\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occupation)}
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_occup)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_occup)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{occup2 }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{f\_occup}
\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{occup2) }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\StringTok{"Self{-}employed"} \OtherTok{=} 
                            \FunctionTok{c}\NormalTok{(}\StringTok{"Farmer"}\NormalTok{ , }\StringTok{"Fisherman"}\NormalTok{ ,}
                          ...
                          \StringTok{"Managers"} \OtherTok{=} 
                            \FunctionTok{c}\NormalTok{(}\StringTok{"Employed professional (employed doctor, etc.)"}\NormalTok{,}
                              \StringTok{"General management, etc."}\NormalTok{, }
                              \StringTok{"Middle management, etc."}\NormalTok{),}
                          \StringTok{"Other white collar"} \OtherTok{=} 
                            \FunctionTok{c}\NormalTok{(}\StringTok{"Employed position, at desk"}\NormalTok{, }
                              \StringTok{"Employed position, travelling"}\NormalTok{),}
                          \StringTok{"Manual workers"} \OtherTok{=} 
                            \FunctionTok{c}\NormalTok{(}\StringTok{"Employed position, service job"}\NormalTok{,}
                              \StringTok{"Supervisor"}\NormalTok{,}
                              \StringTok{"Skilled manual worker"}\NormalTok{,}
                              \StringTok{"Unskilled manual worker, etc."}\NormalTok{),}
                          \StringTok{"House persons"} \OtherTok{=} \StringTok{"Responsible for ordinary shopping, etc."}\NormalTok{,}
                          \StringTok{"Unemployed"} \OtherTok{=} \StringTok{"Unemployed, temporarily not working"}\NormalTok{,}
                          \StringTok{"Retired"} \OtherTok{=}  \StringTok{"Retired, unable to work"}\NormalTok{,}
                          \StringTok{"Student"} \OtherTok{=} \StringTok{"Student"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

One of the things you need to be very careful with when recoding factors or character variables is that you need to input the chunk of texts in the existing variables exactly as they appear in the variable. Otherwise you will get into trouble. So, for example, if in the code above you wrote \texttt{fishermen} instead of \texttt{Fisherman} you would have 14 less cases in the \texttt{Self-Employed} level than you should have. When doing this kind of operations is always convenient to check that the categories add up correctly.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attributes}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}\SpecialCharTok{$}\NormalTok{labels}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{val\_labels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{politics[df}\SpecialCharTok{$}\NormalTok{politics}\SpecialCharTok{\textgreater{}=}\DecValTok{97}\NormalTok{] }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{skim}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{politics\_n }\OtherTok{\textless{}{-}}\FunctionTok{as.numeric}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{skim}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{politics\_n)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{urban[df}\SpecialCharTok{$}\NormalTok{urban}\SpecialCharTok{\textgreater{}=}\DecValTok{8}\NormalTok{] }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\NormalTok{df}\SpecialCharTok{$}\NormalTok{f\_urban }\OtherTok{\textless{}{-}} \FunctionTok{to\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{urban)}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_urban)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_urban))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_urban)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{f\_urban }\OtherTok{\textless{}{-}} \FunctionTok{droplevels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_urban)}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{f\_urban)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{f\_gender }\OtherTok{\textless{}{-}} \FunctionTok{to\_factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{gender)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_f}\SpecialCharTok{$}\NormalTok{complete }\OtherTok{\textless{}{-}} \FunctionTok{complete.cases}\NormalTok{((df\_f))}
\FunctionTok{table}\NormalTok{(df\_f}\SpecialCharTok{$}\NormalTok{complete)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(df\_f}\SpecialCharTok{$}\NormalTok{complete)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-52-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_f}\SpecialCharTok{$}\NormalTok{f\_region }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(df\_f}\SpecialCharTok{$}\NormalTok{region)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_f}\SpecialCharTok{$}\NormalTok{age }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(df\_f}\SpecialCharTok{$}\NormalTok{age)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_f}\SpecialCharTok{$}\NormalTok{at\_sexviol }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(df\_f}\SpecialCharTok{$}\NormalTok{at\_sexviol)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{04-carpentry_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fake\_population}\SpecialCharTok{$}\NormalTok{offender }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{crimecount }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Yes"}\NormalTok{), }\FunctionTok{c}\NormalTok{(}\StringTok{"No"}\NormalTok{))}
\CommentTok{\#Let\textquotesingle{}s check the results}
\FunctionTok{table}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{offender)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fake\_population}\SpecialCharTok{$}\NormalTok{IQ[fake\_population}\SpecialCharTok{$}\NormalTok{offender }\SpecialCharTok{==} \StringTok{"No"}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{64377}\NormalTok{, }\AttributeTok{mean =} \DecValTok{100}\NormalTok{, }\AttributeTok{sd =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fake\_population}\SpecialCharTok{$}\NormalTok{IQ[fake\_population}\SpecialCharTok{$}\NormalTok{offender }\SpecialCharTok{==} \StringTok{"Yes"}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{35623}\NormalTok{, }\AttributeTok{mean =} \DecValTok{92}\NormalTok{, }\AttributeTok{sd =} \DecValTok{20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\#This will give us the mean IQ for the whole population}
\FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\FunctionTok{sample}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(}\FunctionTok{sample}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ, }\DecValTok{10}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{IQ\_mean }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ))}
...
\FunctionTok{names}\NormalTok{(IQ\_mean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(sampd\_IQ\_10}\SpecialCharTok{$}\NormalTok{with) }\CommentTok{\#mean of the sample means}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ) }\CommentTok{\#mean of the population}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{qplot}\NormalTok{(sampd\_IQ\_10}\SpecialCharTok{$}\NormalTok{with, }\AttributeTok{xlab =} \StringTok{"Distribution of means from samples of size 10"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{05-inference_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-22-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{crimecount)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{se\_sampd\_IQ\_100 }\OtherTok{\textless{}{-}} \FunctionTok{favstats}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{with, }\AttributeTok{data=}\NormalTok{sampd\_IQ\_100)}
\NormalTok{se\_sampd\_IQ\_100}\SpecialCharTok{$}\NormalTok{sd}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample\_1 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fake\_population, }\DecValTok{100}\NormalTok{)}
\FunctionTok{mean}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{IQ)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ci\_IQ}\SpecialCharTok{$}\NormalTok{LowerLimit }\OtherTok{\textless{}{-}}\NormalTok{ samp\_IQ\_100 }\SpecialCharTok{{-}}\NormalTok{ me\_IQ\_100}
\NormalTok{ci\_IQ}\SpecialCharTok{$}\NormalTok{UpperLimit }\OtherTok{\textless{}{-}}\NormalTok{ samp\_IQ\_100 }\SpecialCharTok{+}\NormalTok{ me\_IQ\_100}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ci\_IQ}\SpecialCharTok{$}\NormalTok{indx }\OtherTok{\textless{}{-}}\NormalTok{ (ci\_IQ}\SpecialCharTok{$}\NormalTok{LowerLimit }\SpecialCharTok{\textless{}=} \FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ)) }\SpecialCharTok{\&} 
\NormalTok{  (ci\_IQ}\SpecialCharTok{$}\NormalTok{UpperLimit }\SpecialCharTok{\textgreater{}=} \FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ))}
\FunctionTok{sum}\NormalTok{(ci\_IQ}\SpecialCharTok{$}\NormalTok{indx)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ci\_IQ}\SpecialCharTok{$}\NormalTok{id }\OtherTok{\textless{}{-}} \FunctionTok{rownames}\NormalTok{(ci\_IQ)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(ci\_IQ, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ id, }\AttributeTok{y =}\NormalTok{ meanofIQ, }\AttributeTok{ymin =}\NormalTok{ LowerLimit, }\AttributeTok{ymax =}\NormalTok{ UpperLimit, }\AttributeTok{group=}\NormalTok{ indx, }\AttributeTok{color =}\NormalTok{ indx)) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept  =} \FunctionTok{mean}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ), }\AttributeTok{colour =} \StringTok{"red"}\NormalTok{, }\AttributeTok{size =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\#This will create a horizontal line representing the population mean, so that we can clearly see it}
  \FunctionTok{geom\_pointrange}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ LowerLimit, }\AttributeTok{ymax =}\NormalTok{ UpperLimit)) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Confidence intervals for the mean (100 samples of size 100)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{colour=}\StringTok{"Covers μ?"}\NormalTok{, }\AttributeTok{x =} \StringTok{""}\NormalTok{, }\AttributeTok{y =}\StringTok{"Mean of IQ"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_discrete}\NormalTok{(}\AttributeTok{breaks =} \StringTok{""}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\#this ensures that no tick marks and labels are used in the axis defining each sample (try to run the code witout this line to see what happens if you don\textquotesingle{}t include it)}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{IQ)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{IQ, }\AttributeTok{conf.level =}\NormalTok{ .}\DecValTok{99}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{offender)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prop.test}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{offender}\SpecialCharTok{==}\StringTok{"Yes"}\NormalTok{) }\CommentTok{\#We want to estimate the proportion of respondents who are offenders, which is why we specifically ask for those classified as "Yes"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prop.test}\NormalTok{(sample\_1}\SpecialCharTok{$}\NormalTok{offender}\SpecialCharTok{==}\StringTok{"Yes"}\NormalTok{, }\AttributeTok{conf.level =}\NormalTok{ .}\DecValTok{99}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample\_2 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ, }\DecValTok{10}\NormalTok{)}
\NormalTok{sample\_2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample\_3 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ, }\DecValTok{30}\NormalTok{)}
\NormalTok{resampling\_IQ\_30\_1 }\OtherTok{\textless{}{-}} \FunctionTok{do}\NormalTok{(}\DecValTok{1000}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{mean}\NormalTok{(}\FunctionTok{resample}\NormalTok{(sample\_3))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample\_4 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fake\_population}\SpecialCharTok{$}\NormalTok{IQ, }\DecValTok{100}\NormalTok{)}
\NormalTok{resampling\_IQ\_100\_1 }\OtherTok{\textless{}{-}} \FunctionTok{do}\NormalTok{(}\DecValTok{1000}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{mean}\NormalTok{(}\FunctionTok{resample}\NormalTok{(sample\_4))}
\FunctionTok{qdata}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{mean, }\AttributeTok{p =} \FunctionTok{c}\NormalTok{(.}\DecValTok{025}\NormalTok{, .}\DecValTok{975}\NormalTok{), resampling\_IQ\_100\_1)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-45-1.pdf}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-49-1.pdf}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-49-2.pdf}
...
\includegraphics{05-inference_files/figure-latex/unnamed-chunk-49-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(effsize, }\AttributeTok{quietly=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{warn.conflicts=}\ConstantTok{FALSE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{describeBy}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent, BCS0708}\SpecialCharTok{$}\NormalTok{sex)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(psych)}
\FunctionTok{describeBy}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent, BCS0708}\SpecialCharTok{$}\NormalTok{ethgrp2)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(car)}
\FunctionTok{leveneTest}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent, BCS0708}\SpecialCharTok{$}\NormalTok{ethgrp2, }\AttributeTok{center =}\NormalTok{ median)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{BCS0708}\SpecialCharTok{$}\NormalTok{ptcviolent }\OtherTok{\textless{}{-}}\NormalTok{ BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent}\SpecialCharTok{+}\DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{symbox}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{ptcviolent, }\AttributeTok{data=}\NormalTok{BCS0708)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{BCS0708}\SpecialCharTok{$}\NormalTok{bctcviolent }\OtherTok{\textless{}{-}} \FunctionTok{bcPower}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{ptcviolent, }\FloatTok{0.5}\NormalTok{)}
\FunctionTok{ggplot}\NormalTok{(BCS0708, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ bctcviolent)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_density}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qqPlot}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{bctcviolent)}
\end{Highlighting}
\end{Shaded}

\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qqPlot}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent)}
\end{Highlighting}
\end{Shaded}

\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-25-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pairwise.t.test}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{tcviolent, BCS0708}\SpecialCharTok{$}\NormalTok{ethgrp2, }\AttributeTok{p.adjust.method=}\StringTok{"bonferroni"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\includegraphics{06-hypothesis_testing_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{rubbcomm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mytable}\FloatTok{.1} \OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{rubbcomm, BCS0708}\SpecialCharTok{$}\NormalTok{bcsvictim)}
\FunctionTok{chisq.test}\NormalTok{(mytable}\FloatTok{.1}\NormalTok{, }\AttributeTok{simulate.p.value =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mytable}\FloatTok{.2}\OtherTok{\textless{}{-}}\FunctionTok{table}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{bcsvictim, BCS0708}\SpecialCharTok{$}\NormalTok{rubbcomm) }\DocumentationTok{\#\#We first create a new object in tabular form because the function we use to compute Goodman and Kruskal\textquotesingle{}s Gamma needs an object of that nature.}
\FunctionTok{print}\NormalTok{(mytable}\FloatTok{.2}\NormalTok{) }\DocumentationTok{\#\#You can print the content of this object and you will see that it is simply the crosstab with just the counts.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{BCS0708}\SpecialCharTok{$}\NormalTok{bcsvictimR }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{bcsvictim, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}victim of crime\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}not a victim of crime\textquotesingle{}}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{BCS0708}\SpecialCharTok{$}\NormalTok{urban }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(BCS0708}\SpecialCharTok{$}\NormalTok{rural2, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}urban\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}rural\textquotesingle{}}\NormalTok{))}
...
\includegraphics{imgs/model1.PNG}
...
\includegraphics{imgs/model2.PNG}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-7-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{log\_viol\_r)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\FunctionTok{summary}\NormalTok{(fit\_1)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(fit\_1)}\SpecialCharTok{$}\NormalTok{coefficients}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\SpecialCharTok{$}\NormalTok{largest50 }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\FunctionTok{class}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df}\SpecialCharTok{$}\NormalTok{largest50 }\OtherTok{\textless{}{-}} \FunctionTok{fct\_recode}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50, }\AttributeTok{Yes =} \StringTok{"1"}\NormalTok{, }\AttributeTok{No =} \StringTok{"0"}\NormalTok{)}
\FunctionTok{table}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Compute the mean for the smaller cities}
\FunctionTok{mean}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{log\_viol\_r[df}\SpecialCharTok{$}\NormalTok{largest50 }\SpecialCharTok{==} \StringTok{"No"}\NormalTok{], }\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Compute the difference between the two means}
\FunctionTok{mean}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{log\_viol\_r[df}\SpecialCharTok{$}\NormalTok{largest50 }\SpecialCharTok{==} \StringTok{"Yes"}\NormalTok{], }\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{log\_viol\_r[df}\SpecialCharTok{$}\NormalTok{largest50 }\SpecialCharTok{==} \StringTok{"No"}\NormalTok{], }\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{largest50)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tab\_model}\NormalTok{(fit\_4, }\AttributeTok{dv.labels =} \StringTok{"Violence rate (log)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{08-regression_new_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{levels}\NormalTok{(Arrests}\SpecialCharTok{$}\NormalTok{released) }\CommentTok{\#Prints the levels, and you can see that "Yes" comes after "No" in alphabetical order}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{contrasts}\NormalTok{(Arrests}\SpecialCharTok{$}\NormalTok{released) }\CommentTok{\#This function shows you the contrasts associated with a factor. You can see the 1 is associated with "Yes". This is what our model will be predicting, the probability of a "Yes".}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fitl\_1\_prob }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fitl\_1, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{) }\CommentTok{\#If you want to add this to your dataframe you could designate your object as Arrests$fitl\_1\_prob}
\NormalTok{fitl\_1\_prob[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{tab0 }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(harsher\_pred, Arrests}\SpecialCharTok{$}\NormalTok{harsher)}
\NormalTok{tab0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confusionMatrix}\NormalTok{(}\AttributeTok{data=}\NormalTok{harsher\_pred, }\AttributeTok{reference=}\NormalTok{Arrests}\SpecialCharTok{$}\NormalTok{harsher, }\AttributeTok{positive=}\StringTok{"Yes"}\NormalTok{) }\CommentTok{\#The data argument specifies the vector with the predictions and the reference argument the vector with the observed outcome or event. The positive argument identifies the level of interest in the factor.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{precision}\OtherTok{\textless{}{-}}\ControlFlowTok{function}\NormalTok{(c) \{}
\NormalTok{tab1 }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(fitl\_1\_prob}\SpecialCharTok{\textgreater{}}\NormalTok{c, Arrests}\SpecialCharTok{$}\NormalTok{harsher)}
\NormalTok{out }\OtherTok{\textless{}{-}} \FunctionTok{diag}\NormalTok{(tab1)}\SpecialCharTok{/}\FunctionTok{apply}\NormalTok{(tab1, }\DecValTok{2}\NormalTok{, sum)}
\FunctionTok{names}\NormalTok{(out) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}specificity\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}sensitivity\textquotesingle{}}\NormalTok{)}
\FunctionTok{list}\NormalTok{(tab1, out)}
\NormalTok{\}}
\FunctionTok{precision}\NormalTok{(.}\DecValTok{25}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{imgs/fiveb.jpg}
...
\includegraphics{imgs/variabledescription.png}
...
\includegraphics{imgs/tableexample.png}
