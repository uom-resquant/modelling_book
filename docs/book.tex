...
\CommentTok{\#example 3: if you can\textquotesingle{}t find a URL from Canvas to use yet, you can try this random dataset. The dataset itself is irrelevant (although it is about UFO sightings {-} pretty interesting if you ask me), but it does show you how to load data in from a real URL.}
