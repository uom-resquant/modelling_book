...
In other words, we still have only one dependent variable $Y$, which has to be numerical. We also have several independent variables independent variables $X_1, X_2, X_3, ..., X_n$, and for each independent variable we have an associated slope coefficient $\beta_1, \beta_2, \beta_3, ..., \beta_n$.
...
What do to coefficients mean now? **Their interpretation now changes**!
