...
contrasts(Arrests$released) #This function shows you the contrasts associated with a factor. 
#You can see that 1 is associated with "Yes". This is what our model will be predicting: the probability of a "Yes".
```
...
#If you want to add this to your data frame, you could designate your object as Arrests$fitl_1_prob
fitl_1_prob[1:10]
```
...
## Assessing model fit: confusion matrix and ROC curves
...
+ A set of [explanatory notes](http://www.unc.edu/courses/2010fall/ecol/563/001/docs/lectures/lecture20.htm#dealing) by Jack Weiss at the University of North Carolina. Check lessons 20 and 21. I really like the look of his whole course.
