...
So, we know that $p=$ `r table_released[2]` arrestees were released with a summons and that $1-p=$ `r table_released[1]` received a harsher treatment. If we want to calculate the **odds of being released with a summons**, we simply need to calculate the ratio $\frac{p}{1-p}=\frac{4334}{892}$. In this case, the odds are 4.86, which means that being released with a summons is 4.86 times more likely to occur than receiving a harsher treatment.
