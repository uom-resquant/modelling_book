...
This variability is also captured by the standard deviation of the sampling distributions, which is smaller the larger the sample size is. The standard deviation of a sampling distribution receives a special name you need to remember: the **standard error**. In our example, with samples of size 30 the standard error is `r sd(sampd_IQ_30$with)/sqrt(length(sampd_IQ_30))`, whereas with samples of size 1000 the standard error is `r sd(sampd_IQ_1000$with)/sqrt(length(sampd_IQ_1000))`. 
